...
require (
	github.com/AlecAivazis/survey v1.6.2 // indirect
	...
	github.com/briandowns/spinner v0.0.0-20181007213341-d4c882e99950 // indirect
	...
	github.com/versent/saml2aws v2.9.1+incompatible
